"""
Gradio demo app cho ML Research RAG.
Chạy: python app/demo.py
Deploy: đẩy file này + requirements.txt lên Hugging Face Spaces (giống
quy trình đã dùng cho project flood detection). Khi deploy public, đổi
GENERATION_BACKEND=groq trong .env vì HF Spaces free CPU không chạy nổi Ollama.
"""
import sys
